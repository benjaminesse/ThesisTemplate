...
%\usepackage{doi}
%\usepackage{natbib}
\usepackage[backend=biber,style=authoryear,natbib=true,url=false,doi=true,eprint=false]{biblatex}
...
%% Define \biblio command to print bib in subfiles when compiling separately
%\def\biblio{\bibliographystyle{apalike2}\bibliography{references}}
...
%% Undefine the \biblio command for main compiles
\def\biblio{}
