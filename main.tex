%% Main LaTeX file for the thesis. Sets up the page layout, bibliography, front
%% matter and adds the chapters
...
\usepackage{csquotes}                % Ensure quoted texts are typset right
...
%% Set up bibliography
\usepackage[backend=biber, style=apa, natbib=true, maxnames=2, minnames=1,
...
\fancyhead[RO]{\rightmark}     % Set odd pages with chapter name on the right
